...
export class ProjectForm {
  ...
  private onSubmit: (data: Partial<Quote>) => void
  private currentQuote: Quote | null = null

  constructor(onSubmit: (data: Partial<Quote>) => void) {
  ...
  private createOverlay(): void {
    ...
    overlay.querySelector('#confirmBtn')?.addEventListener('click', () => this.handleSubmit())
