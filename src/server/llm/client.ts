...
export class LLMClient {
  ...
  async chat(
    ...
    onToolExecute: ToolExecuteCallback
  ): Promise<string> {
    ...
    while (true) {
      ...
      for (const idx of Object.keys(toolCallMap).sort((a, b) => Number(a) - Number(b))) {
      ...
      for (const tc of toolCalls) {
        ...
        const result = await onToolExecute(tc.function.name, args)
